...
(function (chat) {
    var App = /** @class */ (function () {
        function App() {
            ...
            this.applicationId = 'f469c47e-f287-48d8-8c28-1314f3d3c6b5';
            this.channelId = new URLSearchParams(window.location.search).get('streamName');
            ...
            fm.liveswitch.Log.registerProvider(new fm.liveswitch.DomLogProvider(fm.liveswitch.LogLevel.Debug));
        }
        App.prototype.setUserName = function (userName) {
            this.userName = userName;
        };
        App.prototype.startLocalMedia = function (videoContainer) {
            var _this = this;
            ...
            try {
                ...
                fm.liveswitch.Plugin.install(pluginConfig).then(function (result) {
                    ...
                    var audio = true;
                    var video = new fm.liveswitch.VideoConfig(_this.videoWidth, _this.videoHeight, _this.videoFps);
                    _this.localMedia = new fm.liveswitch.LocalMedia(audio, video, false);
